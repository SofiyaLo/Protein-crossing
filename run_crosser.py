...
pr_ortho_tsv = r'C:\Users\Professional\PycharmProjects\Protein-crossing\Prot_ortho_results\very_sensitive.proteinortho.tsv'

w_ortho_df = PoFF_analysis.ortho_weight_reader(pr_ortho_tsv, 2)
unw_ortho_df = PoFF_analysis.ortho_unweight_reader(pr_ortho_tsv, 2)
